...
namespace Solana.Web.Admin.Models.Responses.OnlineApplications
{
    public class GetAdmFroOptionsResponse
    {
        ...
        public ICollection<FroCustomizationViewModel> Customizations { get; set; }
    }
}
