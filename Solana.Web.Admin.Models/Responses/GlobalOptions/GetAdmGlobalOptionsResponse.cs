...
namespace Solana.Web.Admin.Models.Responses.GlobalOptions
{
    ...
    public class GetAdmGlobalOptionsResponse
    {
        [Required]
        public System.DateTime YearBeginsOn { get; set; }
        ...
        public List<AgeGroupsViewModel> AgeGroups { get; set; } = new List<AgeGroupsViewModel>();

        public List<CEPSchoolOptionsModel> CepSchoolOptionsItemList { get; set; } = new List<CEPSchoolOptionsModel>();
    }
}
